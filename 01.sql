INSERT INTO users (email, password, username, phone, city, created_at) VALUES
    ('sachin@gmail.com', 'abcd', 'Sachin Yadav', 9972934723, 'Madrid', '2005-02-01 01:47:46'),
    ('anuj@yahoo.com', 'abcd', 'Anuj Jain', 7502740385, 'Ludhiana', '2005-02-01 01:47:47'),
    ('kavya@rediffmail.com', 'abcd', 'Kavya Agarwal', 2035753956, 'Madrid', '2005-02-01 01:47:48'),
    ('niraj@gmail.com', 'abcd', 'Niraj Kumar', 7535765756, 'Delhi', '2005-02-01 01:47:49'),
    ('anmol@yahoo.com', 'abcd', 'Anmol Gautam', 9383729512, 'Madrid', '2005-02-01 01:47:50'),
    ('dhiraj@outlook.com', 'abcd', 'Dhiraj Sinha', 3829893782, 'Jaipur', '2005-02-01 01:47:51'),
    ('kunal@iitgn.ac.in', 'abcd', 'Kunal Kumar', 6483026593, 'Delhi', '2005-02-01 01:47:52'),
    ('aditya@iitgn.ac.in', 'abcd', 'Aditya Puri', 3289037502, 'Chandigarh', '2005-02-01 01:47:53'),
    ('sushant.kumar@gmail.com', 'abcd', 'Sushant Kumar', 3792052942, 'Mumbai', '2005-02-01 01:47:54'),
    ('kalyan.reddy@iitgn.ac.in', 'abcd', 'Kalyan G. Reddy', 3920395343, 'Mumbai', '2005-02-01 01:47:55'),
    ('sushant.goyal@gmail.com', 'abcd', 'Sushant Goyal', 7583925935, 'Delhi', '2005-02-01 01:47:56'),
    ('andy043@gmai.com', 'abcd', 'Andy Murray', 4832840284, 'Madrid', '2005-02-01 01:47:57'),
    ('nicole58@yahoo.com', 'abcd', 'Nicole Ray', 8302643252, 'Madrid', '2005-02-01 01:47:58'),
    ('jon380@rediffmail.com', 'abcd', 'Jon Duse', 7296937501, 'New York', '2005-02-01 01:47:59'),
    ('ted.yeagar@gmail.com', 'abcd', 'Ted Yeagar', 9229247529, 'San Diego', '2005-02-01 01:48:00'),
    ('eren.yeagar@gmail.com', 'abcd', 'Eren Yeagar', 4890850883,'Shiganshina', '2005-02-01 01:48:01'),
    ('mikasa.ackermann@gmail.com', 'abcd', 'Mikasa Ackermann', 7538925381, 'Shiganshina', '2005-02-01 01:48:02'),
    ('armin.arlert@yahoo.com', 'abcd', 'Armin Arlert', 8539023535, 'Shiganshina', '2005-02-01 01:48:03'),
    ('historia80@rediffmail.com', 'abcd', 'Historia Reiss', 8043253387, 'Ross', '2005-02-01 01:48:03'),
    ('levi84@yahoo.com', 'abcd', 'Captain Levi', 3953647233, 'Maria', '2005-02-01 01:48:04');

 INSERT INTO retailers(email, name , phone, password, street, city, province, pincode) VALUES
    ('pvs840@gmail.com', 'PVS Ltd.', 3284002487, 'abcd', 'Linkoln Street', 'Ahmedabad', 'Gujarat', 840235),
    ('cfd@gmail.com', 'CFD Ltd.', 7843963241, 'abcd', 'Gandhi Lane', 'Ahmedabad', 'Gujarat', 840785),
    ('pravin@yahoo.com', 'Pravin Brothers and Co.', 9837295263, 'abcd', 'Plot 54', 'Delhi', 'Delhi', 392563),
    ('nfs@rediffmail.com', 'NFS Pvt. Ltd.', 5792925363, 'abcd', 'Gramin Lane', 'Ludhiana', 'Punjab', 432985),
    ('csd@gmail.com', 'CDS Pvt. Ltd.', 5403640253, 'abcd', 'Indranagar', 'Delhi', 'Delhi', 840263),
    ('ydt@yahoo.com', 'YDT Bhandar', 4803284093, 'abcd', 'Linkoln Street','Ahmedabad', 'Gujarat', 840235),
    ('bts@gmail.com', 'BTS Bazaar', 7382953636, 'abcd', 'Malviya Nagar', 'Ahmedabad', 'Gujarat', 830253),
    ('netejs@yahoo.com', 'Neten Pvt. Ltd.', 8392846382, 'abcd', 'Nind Industrial Complex', 'Jaipur', 'Rajasthan', 328032),
    ('lincoln@gmail.com', 'Lincoln Brothers', 9024626203, 'abcd', 'Dukar', 'Jaipur', 'Rajasthan', 325326),
    ('pratap@gmail.com', 'Pratap Traders', 7892592623, 'abcd', 'Hinaya Building', 'Ahmedabad', 'Gujarat', 472932),
    ('puona@rediffmail.com', 'Puona Traders', 7925292032, 'abcd', 'Vistras Center', 'Ahmedabad', 'Gujarat', 298532),
    ('disco@gmail.com', 'Discoin Traders', 2908526202, 'abcd', 'Mistes', 'Jaipur', 'Rajasthan', 842223),
    ('niagra@yahoo.com', 'Niagra Falls Pvt. Ltd', 8026830623, 'abcd', 'Vista', 'Bhopal', 'Madhya Pradesh', 274252),
    ('nikon@rediffmail.com', 'Nikon Distributors', 8037342386, 'abcd', 'Nikon Building', 'Rewari', 'Haryana', 243563),
    ('tekken@gmail.com', 'Tukaram Pvt. Ltd.', 7296332759, 'abcd', 'Tekken Cross', 'Ahmedabad', 'Gujarat', 840253),
    ('fda@gmail.com', 'FDA Ltd.', 8403236732, 'abcd', 'FD building', 'Ahmedabad', 'Gujarat', 204252),
    ('creates@yahoo.com', 'Creates Delhi Ltd.', 2035263343, 'abcd', 'Mahavir Marg', 'Delhi', 'Delhi', 203953),
    ('tiny.ants@rediffmail.com', 'Tiny Ants Distributors', 3295328539, 'abcd', 'Akshardham Marg', 'Ahmedabad', 'Gujarat', 290842),
    ('tuamir@gmail.com', 'Tuamir Co.', 3820529239, 'abcd', 'Buddha Road', 'Ahmedabad', 'Gujarat', 840235),
    ('quench@rediffmail', 'Quench Pvt. Ltd.', 8303259322, 'abcd', 'Niagra Marg', 'Delhi', 'Delhi', 389253);

-- INSERT INTO products (name, 
INSERT INTO products (name, category, retailer_id, price, created_at) VALUES
    ('Da Vinci Code', 'novels', 2, 450, '2012-12-22 01:47:46'),
    ('War and Peace', 'novels', 5, 1130, '2011-06-26 01:47:46'),
    ('Ulysses', 'novels', 5, 530, '2019-05-31 01:47:46'),
    ('The Lord of the Rings', 'novels', 2, 675, '2020-12-01 01:47:46'),
    ...
    ('Xiaomi S9 Pro', 'electronics', 1, 15000, '2015-02-09 01:47:46'),
    ('Xiomi Note 4', 'electronics', 1, 20000, '2010-11-21 01:47:46'),
    ('Neomi Watch R2','electronics', 8, 3600, '2008-02-10 01:47:46'),
    ('LG Washing Machine M4', 'electronics', 7, 16500, '2015-12-01 01:47:46'),
    ('Neomi Watch D5', 'electronics', 8, 11000, '2020-09-07 01:47:46'),
    ('HP Paviliion G6', 'electronics', 7, 56000, '2016-01-06 01:47:46'),
    ('Acer Predator Helio', 'electronics', 1, 74500, '2015-05-01 01:47:46'),
    ('Dell Inspiron D3', 'electronics', 9, 45000, '2010-09-07 01:47:46'),
    ('Dell Inspiron G4', 'electronics', 9, 55000, '2013-02-26 01:47:46'),
    ('Apple macbook Air', 'electronics', 10, 85000, '2019-12-27 01:47:46'),
...
INSERT INTO novels (pdt_id, author, publisher, publication_date) VALUES
    (1, 'Dan Brown', 'Penguin Books', '2016-08-05 01:47:46'),
...
INSERT INTO electronics (pdt_id, category, brand, model) VALUES 
    (12, 'Mobile', 'Xiaomi', 'S9'),
...
INSERT INTO clothes (pdt_id, brand, model) VALUES 
    (24, 'Leeves', 'SM slim M9');

INSERT INTO addresses (user_id, street, city, province, pincode) VALUES
    (1, 'Gangamma Circle, Jalahalli', 'Bangalore', 'Karnataka', 560013),
    (2, 'Main Rd, Chick Pet', 'Bangalore', 'Karnataka', 560053),
    (3, 'Shanti Park, Mira Road', 'Mumbai', 'Maharashtra', 401107),
    (4, 'Paradise Cinema Lane, Mahim', 'Mumbai', 'Maharashtra', 40016),
    ...
    (12, '39, Ans Patkar Road, Grant Road', 'Mumbai', 'Maharashtra', 400007),
    (13, '6/85, W E A, Padam Singh Road, Karol Bagh', 'Delhi', 'Delhi', 110005),
    (14, 'Rashi Bldg, 7 Poice Court Lane', 'Mumbai', 'Maharashtra', 400001),
    (15, 'G15, 174/40, 8th F Main, 3rd Block, Jaynagar', 'Bangalore', 'Karnataka', 560011),
    (16, '66, Mehdipatnam', 'Hyderabad', 'Andhra Pradesh', 500028),
    (17, ' A/2, Vardhman Darshan, Jamli Galli, Borivali', 'Mumbai', 'Maharashtra', 400092),
    (18, 'Near Post Office, Nehru Road, Santa Cruz (east)', 'Mumbai', 'Maharashtra', 400055),
    (19, '58, 1719/2 Phase 3, Vatva', 'Ahmedabad', 'Gujarat', 382445),
...
-- Order 1
INSERT INTO orders (user_id, created_at, price, street, city, province , pincode) VALUES (1, '2010-01-08 02:44:00', 730, 'Gangamma Circle, Jalahalli', 'Bangalore', 'Karnataka', 560013);
...
-- Order 2
INSERT INTO orders (user_id, created_at, price, street, city, province , pincode) VALUES (1, '2020-10-15 02:44:00', 45000, 'Gangamma Circle, Jalahalli', 'Bangalore', 'Karnataka', 560013);
...
-- Order 3
INSERT INTO orders (user_id, created_at, price, street, city, province , pincode) VALUES (1, '2020-11-10 02:44:00', 480, 'Gangamma Circle, Jalahalli', 'Bangalore', 'Karnataka', 560013);
...
INSERT INTO user_views (pdt_id, user_id, created_at) VALUES 
    (6, 10, '2021-01-30 04:47:46'),
...
-- Order 4
INSERT INTO orders (user_id, created_at, price, street, city, province , pincode) VALUES (4, '2020-11-06 02:44:00', 35000, 'Paradise Cinema Lane, Mahim', 'Mumbai', 'Maharashtra', 40016);
INSERT INTO order_items (order_id, user_id, pdt_id, quantity, price_of_each) VALUES (4, 4, 28, 1, 35000);

-- Order 5
INSERT INTO orders (user_id, created_at, price, street, city, province , pincode) VALUES (4, '2020-11-10 02:44:00', 45000, 'Paradise Cinema Lane, Mahim', 'Mumbai', 'Maharashtra', 40016);
INSERT INTO order_items (order_id, user_id, pdt_id, quantity, price_of_each) VALUES (5, 4, 19, 1, 45000);

-- Order 6
INSERT INTO orders (user_id, created_at, price, street, city, province , pincode) VALUES (4, '2020-11-13 02:44:00', 180, 'Paradise Cinema Lane, Mahim', 'Mumbai', 'Maharashtra', 40016);
INSERT INTO order_items (order_id, user_id, pdt_id, quantity, price_of_each) VALUES (6, 4, 11, 1, 120);

INSERT INTO reviews (pdt_id, user_id, username, rating, body, created_at) VALUES
    (28, 4, 'Niraj Kumar', 5, 'wonderful product, loved it!', '2020-12-09 03:36:45'),
...
-- Order 7
INSERT INTO orders (user_id, created_at, price, street, city, province , pincode) VALUES (2, '2018-11-13 02:44:00', 500, 'Main Rd, Chick Pet', 'Bangalore', 'Karnataka', 560053);
INSERT INTO order_items (order_id, user_id, pdt_id, quantity, price_of_each) VALUES (7, 2, 1, 1, 450);
-- Order 8
INSERT INTO orders (user_id, created_at, price, street, city, province , pincode) VALUES (3, '2017-11-13 02:44:00', 1130, 'Shanti Park, Mira Road', 'Mumbai', 'Maharashtra', 401107);
INSERT INTO order_items (order_id, user_id, pdt_id, quantity, price_of_each) VALUES (8, 3, 2, 1, 1130);

INSERT INTO reviews (pdt_id, user_id, username, rating, body, created_at) VALUES
    (1, 2, 'Anuj Jain', 4, NULL, '2020-10-09 03:36:45'),
    (2, 3, 'Kavya Agarwal', 3, 'I found the book to be okayish. The hype was not worth it.', '2020-09-11 03:36:45');


-- Order 9
INSERT INTO orders (user_id, created_at, price, street, city, province , pincode) VALUES (3, '2018-11-13 02:44:00', 3250, 'Shanti Park, Mira Road', 'Mumbai', 'Maharashtra', 401107);
INSERT INTO order_items (order_id, user_id, pdt_id, quantity, price_of_each) VALUES 
    (9, 3, 1, 6, 450),
    (9, 3, 8, 1, 550);

-- Order 10
INSERT INTO orders (user_id, created_at, price, street, city, province , pincode) VALUES (5, '2017-11-13 02:44:00', 20000, 'Shop 4, Mira Road', 'Mumbai', 'Maharashtra', 401107);
INSERT INTO order_items (order_id, user_id, pdt_id, quantity, price_of_each) VALUES 
    (10, 5, 13, 1, 20000);
